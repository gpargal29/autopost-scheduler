...
import { Bot, Mail, Lock, LogIn, AlertCircle, Loader2, Eye, EyeOff } from 'lucide-react';
    ...
    <div class="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div class="w-full max-w-md glass-panel p-8 rounded-3xl border border-slate-800 shadow-2xl relative z-10">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-xs text-slate-400 mt-1">Log in to your AutoPost AI dashboard</p>
        </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                class="w-full pl-11 pr-12 py-3 bg-slate-900/90 border border-slate-800 rounded-xl text-white placeholder:text-slate-600 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 text-sm transition-all"
                required
              />
              <button
                type="button"
                onClick={() => setShowPassword((prev) => !prev)}
                class="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-400 transition-colors"
        ...
        <div class="mt-8 text-center text-xs text-slate-400">
          ...
          <Link to="/register" class="text-brand-400 font-semibold hover:underline">
            Create an account
          </Link>
        </div>
      </div>
